...
@deployment_bp.route('/generate-external-id', methods=['POST'])
@jwt_required()
def generate_external_id():
        ...
        {'user_id': user_id},
        {
            ...
            '$push': {
                'deployment_logs': {
                    ...
                    'message': 'External ID generated/refreshed'
                }
            }
        },
        upsert=True
    ...
    return jsonify({
        'external_id': external_id,
        'message': 'External ID generated. Create AWS role with this External ID.'
    }), 201
...
def submit_arn():
    ...
    if not deployment:
        return jsonify({'msg': 'Generate External ID first'}), 400
    ...
    try:
        ...
        print("Assumed role session established successfully.")
